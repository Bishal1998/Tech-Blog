                                ...
                                <div className='lg:hidden'>
                                    {
                                        currentUser ? (
                                            <div className='flex flex-col justify-center items-center gap-4'>
                                                ...
                                                {
                                                    currentUser.isAdmin && <NavLink to='/dashboard?tab=posts' className={({ isActive }) => isActive ? ' text-white  mx-auto bg-dark-8 rounded-xl p-4 text-lg   ' : 'p-4 text-lg'} >Posts</NavLink>
