...
const NewsComp = ({ image, title, category, slug }) => {

    return (
        <article className='space-y-4 w-full h-full'>
            <img src={image} alt={title} height={222} className='w-full rounded-xl h-[222px] object-cover' />
            ...
            <div className="flex gap-4 whitespace-nowrap font-kumbh text-sm 2xl:text-lg text-gray-60">
                ...
                <Link to={`/posts/${slug}`} className='flex items-center justify-center py-4 px-6 rounded-xl border border-dark-15 bg-dark-8 font-inter text-lg text-gray-60 gap-2'>
                    Read More
