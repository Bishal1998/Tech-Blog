        ...
        <section className='w-full mx-auto'>
            ...
            <form className='w-[90%] mx-auto flex flex-col justify-center gap-6'>
                <div className='flex flex-col md:flex-row justify-between gap-4'>
                    <input type="text" placeholder='Title' name='title' className='flex-1 border border-dark-15 bg-dark-15 outline-none shadow-[0_0_0_4px_#191919] p-5 rounded-lg font-inter text-dark-40 text-lg mb-4' />
