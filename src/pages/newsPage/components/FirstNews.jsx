...
const FirstNews = () => {
    ...
    const desc = content?.length > maxLength ? content.substring(0, maxLength) + "...." : content
    ...
    return (
        <article className='w-full px-6 py-6 lg:px-20 lg:py-16 border-b border-t border-dark-15 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-12'>
            <img src={image} alt="" className='w-full xl:w-[515px] h-[325px] object-cover rounded-xl' />
            <div className='font-inter'>
                ...
                <div className="flex justify-between gap-4 whitespace-nowrap font-kumbh text-sm 2xl:text-lg text-gray-60">
                    ...
                    <Link to={`/posts/${slug}`} className='py-4 px-6 rounded-xl border border-dark-15 bg-dark-8 font-inter text-lg text-gray-60 hover:bg-dark-10'>
                        Read More
                    </Link>
                </div>
            </div>
